...
import DestinationTrackerContainer from "./DestinationTrackerContainer";

describe("DestinationTrackerContainer", () => {
  const renderComponent = (children) =>
    render(
      <DestinationTrackerContainer>{children}</DestinationTrackerContainer>
    );
